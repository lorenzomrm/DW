...
def set_pet(request):
    ...
    if pet_id:
        ...
        pet = Pet.objects.create(nome=nome, idade=idade, sexo=sexo, especie=especie, raca=raca, porte=porte, descricao=descricao, castrado=castrado, email=email, telefone=telefone,
                                user=user, foto=file)
